...
#else
#define TEMP_POS_60_THRESHOLD  55//50
#endif

#define TEMP_POS_60_THRES_MINUS_X_DEGREE 48

#define TEMP_POS_45_THRESHOLD  45
#define TEMP_POS_45_THRES_MINUS_X_DEGREE 28 //39

#ifdef CONFIG_CHARGER_BQ2589X
#define TEMP_POS_30_THRESHOLD  40
#else
...
#define TEMP_POS_10_THRES_PLUS_X_DEGREE 16//16

#define TEMP_POS_0_THRESHOLD  0
#define TEMP_POS_0_THRES_PLUS_X_DEGREE 3 //6
...
/*[---Start add by Rachel, support 2nd battery,20141208---]*/
/*****************************************************************************
 *  structure
 ****************************************************************************/
