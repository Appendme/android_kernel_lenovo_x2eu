...
#else
	mt_set_gpio_mode(smart_set_gpio(GPIO_NXPSPA_I2S_LRCK_PIN) , GPIO_MODE_01);
	mt_set_gpio_mode(smart_set_gpio(GPIO_NXPSPA_I2S_BCK_PIN), GPIO_MODE_01);
	mt_set_gpio_mode(smart_set_gpio(GPIO_NXPSPA_I2S_DATAIN_PIN), GPIO_MODE_01);
	mt_set_gpio_mode(smart_set_gpio(GPIO_NXPSPA_I2S_DATAOUT_PIN), GPIO_MODE_01);
#endif
}
