...
/* Special subsys */
/*
DECLARE_CMDQ_SUBSYS(CMDQ_SUBSYS_PWM0_SW, 25, SPECIAL, pwm0_sw_base)
DECLARE_CMDQ_SUBSYS(CMDQ_SUBSYS_PWM1_SW, 26, SPECIAL, pwm1_sw_base)
DECLARE_CMDQ_SUBSYS(CMDQ_SUBSYS_DIP_A0_SW, 27, SPECIAL, dip_a0_sw_base)
*/
