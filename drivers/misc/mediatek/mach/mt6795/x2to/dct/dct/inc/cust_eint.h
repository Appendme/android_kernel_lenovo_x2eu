...
#define CUST_EINT_DT_EXT_MD_EXP_NUM              9
...
#define CUST_EINT_DT_EXT_MD_WK_UP_USB_NUM              55
#define CUST_EINT_DT_EXT_MD_WK_UP_USB_DEBOUNCE_CN      0
#define CUST_EINT_DT_EXT_MD_WK_UP_USB_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_DT_EXT_MD_WK_UP_USB_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_DT_EXT_MD_WK_UP_NUM              56
#define CUST_EINT_DT_EXT_MD_WK_UP_DEBOUNCE_CN      0
#define CUST_EINT_DT_EXT_MD_WK_UP_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_DT_EXT_MD_WK_UP_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_CHR_STAT_NUM              124
